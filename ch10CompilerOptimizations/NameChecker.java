...
public class NameChecker {
    ...
    /**
     * 对Java程序命名进行检查,根据《Java语言规范(第3版)》第6.8节的要求，Java程序命名规则如下:
     *
     * <ul>
     *     <li>类或者接口: 符合驼式命名法, 首字母大写
     *     <li>方法: 符合驼式命名法，首字母小写
     *     <li>字段:
     *     <ul>
    ...
    /**
     * 名称检查器实现类,继承了JDK1.7中提供的ElementScanner7
    ...
    private class NameCheckScanner extends ElementScanner7<Void, Void> {
        ...
        public Void visitExecutable(ExecutableElement e, Void p) {
            if (e.getKind() == METHOD) {
                ...
                if (name.contentEquals(e.getEnclosingElement().getSimpleName()))
                    messager.printMessage(Diagnostic.Kind.WARNING, "一个普通方法 " + name + " 不应当与类名重复，避免构造函数产生混乱", e);
        ...
        public Void visitVariable(VariableElement e, Void p) {
            // 如果这个Variable 是枚举或常量, 则按大写名称检查,否则按照驼式命名法则检查
        ...
        /**
         * 检查传入的Element是否符合驼式命名法，如果不符合，则输出警告
         */
        ...
        /**
         * 大写命名检查,要求第一个字母必须是大写的英文字母,其余部分可以是大写或是下划线
         */
        private void checkAllCaps(Element e) {
            ...
            if (!conventional)
                messager.printMessage(Diagnostic.Kind.WARNING, " 常量 " + name + "应当全部以大写字母或是下划线命名,并且以字母开头", e);
        }
    }
}
